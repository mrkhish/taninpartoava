        ...
        <div class="dez-bnr-inr overlay-black-middle" style="background-image: url('{{ asset('images/background/download.jpg')}}');">
            <div class="container">
                <div class="dez-bnr-inr-entry">
                    <h1 class="text-white">پروژه ها</h1>
                </div>
            </div>
        </div>
  ...
  <path d="M11.742 10.344a6.5 6.5 0 1 0-1.397 1.398h-.001q.044.06.098.115l3.85 3.85a1 1 0 0 0 1.415-1.414l-3.85-3.85a1 1 0 0 0-.115-.1zM12 6.5a5.5 5.5 0 1 1-11 0 5.5 5.5 0 0 1 11 0"/>
					...
					<div class="row" id="masonry">
							...
							<div class="col-md-6 col-lg-4 col-sm-12 m-b30 product-item card-container ">
								<div class="dez-box border rounded shadow p-3 mb-5 bg-white">
									<div class="dez-thum-bx  dez-img-effect rounded "> <img style="height: 300px; width: 300px;" src="{{ asset('media/'.$project->img) }}" alt="{{$project->name}}" title="{{$project->name}}">
										
									</div>
									<div class="dez-info p-a20 text-center">
										<h4 class="dez-title m-t0 text-uppercase"><a href="{{route('news.detail',['slug'=>$project->slug])}}">{{$project->name}}</a></h4>
										<h3 class="m-b0">{{$project->slug}} </h3>
										<div class="m-t20">
										    
											
												<a class="text-dark" href="{{route('news.detail',['slug'=>$project->slug])}}" title="اطلاعات بیشتر" rel="bookmark" class=" site-button-link rounded"><button type="button" class="btn btn-warning rounded"> اطلاعات بیشتر 
