        ...
        <div class="dez-bnr-inr overlay-black-middle" style="background-image: url('{{ asset('images/background/download.jpg')}}');">
            <div class="container">
                <div class="dez-bnr-inr-entry">
                    <h1 class="text-white">جزئیات محصول</h1>
					<div class="dez-separator bg-primary"></div>
					<p class="text-white max-w800">{{ $detail->slug}}</p>
                </div>
            </div>
        </div>
					...
					<div class="col-lg-9 col-md-8 col-sm-6">
						<div class="row">
							<div class="col-md-12 col-lg-12">
								<div class="dez-box">
									<div class="dez-media"> <a><img class="ImgOfDetail shadow p-3 mb-5 bg-white rounded"  src="{{ asset('media/' .$detail->img) }}" alt="{{ $detail->name}}" title="{{ $detail->title}}"></a> </div>
									<div class="dez-info m-t30 ">
										<h2 class="dez-title m-t0">{{ $detail->lead}} </h2>
										<h4 class="p-3 text-justify text-dark" style="text-align: justify;"> {!! ($detail->content) !!}</h4><br><span class="badge badge-info">
										<p> {{($detail->price) }}</p></span>
									</div>
									<div class="dez-info m-t30 ">
						...
						<div class="side-sticky">
							<div class="icon-bx-wraper bx-style-1 p-a30 center m-b15 shadow p-3 mb-5 bg-white rounded">
							 <div class="widget bg-white p-a20 widget_tag_cloud">
                                ...
                                <div class="tagcloud"> <a href="#">{{ $detail->tags}}</a> </div>
                            </div>
							</div>
